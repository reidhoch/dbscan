...
dotnet minicover instrument --workdir ../ --assemblies DbScan.Tests/**/bin/**/*.dll --sources DbScan/**/*.cs
...
for project in DbScan.Tests/*.csproj; do dotnet test --no-build $project; done
