...
namespace DbScan.Tests
{
    public class DbScanClustererTests
    {
        ...
        {
            var clusterer = new DBScanClusterer<DoublePoint>(2.0, 5);
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => new DBScanClusterer<DoublePoint>(-2.0, 5));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new DBScanClusterer<DoublePoint>(2.0, 5).Cluster(null));
        }
    }
}
